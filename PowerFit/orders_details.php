...
<head>
  ...
  <title>PowerFit Body Building Equipment and Supplement Shop : Order Details</title>
  <!-- Bootstrap -->
    ...
    <body>
      ...
      try {
        ...
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a180719, tbl_staffs_a180719_pt2,
          tbl_customers_a180719_pt2 WHERE
      ...
      <div class="container-fluid">
            ...
            <div class="panel panel-default">
              ...
              <table class="table">
                <tr>
                  ...
                  <td><?php echo $readrow['fld_orderID'] ?></td>
                </tr>
                <tr>
                  <td><strong>Order Date</strong></td>
                  <td><?php echo $readrow['fld_orderDate'] ?></td>
                </tr>
                <tr>
          ...
          <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <form action="orders_details.php" method="post" class="form-horizontal" name="frmorder" id="forder" onsubmit="return validateForm()">
                ...
                <div class="col-sm-9">
                  <select name="productID" class="form-control" id="productID">
                    ...
                    foreach($result as $productrow) {
                      ?>
                      <option value="<?php echo $productrow['fld_productID']; ?>"><?php echo $productrow['fld_productName']; ?></option>
                      <?php
                    }
                    $conn = null;
                    ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input name="orderDetailQuantity" type="number" class="form-control" id="qty" min="1">
                </div>
              </div>
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9">
                  <input name="orderID" type="hidden" value="<?php echo $readrow['fld_orderID'] ?>">
          ...
          <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <table class="table table-striped table-bordered">
              ...
              foreach($result as $detailrow) {
                ?>
                <tr>
                  <td><?php echo $detailrow['fld_orderDetailID']; ?></td>
                  <td><?php echo $detailrow['fld_productName']; ?></td>
                  <td><?php echo $detailrow['fld_orderDetailQuantity']; ?></td>
                  <td>
                    <a href="orders_details.php?delete=<?php echo $detailrow['fld_orderDetailID']; ?>&orderID=<?php echo $_GET['orderID']; ?>" onclick="return confirm('Are you sure to delete?');" class="btn btn-danger btn-xs" role="button">Delete</a>
                  </td>
                </tr>
              <?php } ?>
            </table>
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            <a href="invoice.php?orderID=<?php echo $_GET['orderID']; ?>" target="_blank" role="button" style="background-color: #6495ED" class="btn btn-primary btn-lg btn-block">Generate Invoice</a>
          </div>
        </div>
        <br>
      </div>
      ...
      <script type="text/javascript">
        ...
        function validateForm() {
          ...
          var x = document.forms["frmorder"]["productID"].value;
          var y = document.forms["frmorder"]["orderDetailQuantity"].value;
      //var x = document.getElementById("prd").value;
      //var y = document.getElementById("qty").value;
          if (x == null || x == "") {
            alert("Product must be selected");
            document.forms["frmorder"]["productID"].focus();
          //document.getElementById("prd").focus();
            return false;
          }
          if (y == null || y == "") {
            alert("Quantity must be filled out");
            document.forms["frmorder"]["orderDetailQuantity"].focus();
